...
% Chain-phase calibration (compute_L2) has no entry-script knobs: each
% capture is corrected by its own UHD session's measured inter-channel chain
% phase, subtracted in full (docs/config-reference.md#chain-cal-knobs).
