...
% Per-site weather-station column names for the viewer's four overlay
% checkboxes (Snow depth, SWE, AirTC_Avg, Temp_C_Avg) — enter each site's
% headers in site_config.json's weather block; null/absent keys fall back to
% the Brundage defaults in load_snodar.
...
% wx_swe_cols is {value, error_code} for the snow-scale SWE overlay.
